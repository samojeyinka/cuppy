...
const Hero = () => {
 ...
 <svg width="40" height="40" viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
...
repeatCount="indefinite" />
 ...
 Listen Now</button>  
            ...
            <button
            onClick={btnClicked2}
             className={`button button-2 ${clicked2 ? 'active-button-2' : ''}`}>Book Now</button>  
            </Link>
        </div>
        <div className="gallery">
            <i className="gallery_controller"><FaAngleLeft/></i>
                ...
                <i className="gallery_controller"><FaAngleRight/></i>
        </div>
      </div>
